...
\noindent Values in the column GDPWdiff were initially integers. In a new column, GDPWdiff\_category, the integers were transformed into 3 factors. If the integer was less than 0, then it was transformed to be the category "negative". If the integer was greater than 0, then it was transformed to be the category "positive". Otherwise, the integer equaled 0 and was transformed to be the category "no change".
...
\noindent Note: The standard errors for OIL are quite high, approximately 6.89, which may be impacting the precision of results.

\vspace{.25cm}

\noindent The negative category intercept, 3.805370, represents the log-odds that a country's GDP difference will be negative, as compared to the baseline category ("no change"), when the country is not a democracy and the country's average ratio of fuel exports to total exports in 1984-1986 did not exceed 50 percent.

\vspace{.25cm}

\noindent The positive category intercept, 4.533759, represents the log-odds that a country's GDP difference will be positive, as compared to the baseline category ("no change"), when the country is not a democracy and the country's average ratio of fuel exports to total exports in 1984-1986 did not exceed 50 percent.

\vspace{.25cm}

\noindent The negative category REG coefficient, 1.38, represents the log-odds that a country's GDP difference will be negative, holding OIL constant, as compared to the baseline category ("no change") if a country is a democracy instead of a non-democracy.

\vspace{.25cm}

\noindent The positive category REG coefficient, 1.79, represents the log-odds that a country's GDP difference will be positive, holding OIL constant, as compared to the baseline category ("no change") if a country is a democracy instead of a non-democracy.

\vspace{.25cm}

\noindent The negative category OIL coefficient, 4.78, represents the log-odds that a country's GDP difference will be negative, holding REG constant, as compared to the baseline category ("no change") if a country's average ratio of fuel exports to total exports in 1984-1986 exceeded 50 percent (compared to if a country's fuel export ratio did not exceed 50 percent).

\vspace{.25cm}

\noindent The positive category OIL coefficient, 4.57, represents the log-odds that a country's GDP difference will be positive, holding REG constant, as compared to the baseline category ("no change") if a country's average ratio of fuel exports to total exports in 1984-1986 exceeded 50 percent (compared to if a country's fuel export ratio did not exceed 50 percent).
...
\noindent The odds are 44.94 times higher that a country's GDP difference will be negative (as opposed to the baseline category of "no change"), when the country is not a democracy and the country's average ratio of fuel exports to total exports in 1984-1986 did not exceed 50 percent.

\vspace{.25cm}

\noindent The odds are 93.11 times higher that a country's GDP difference will be positive (as opposed to the baseline category of "no change"), when the country is not a democracy and the country's average ratio of fuel exports to total exports in 1984-1986 did not exceed 50 percent.


\vspace{.25cm}

\noindent In a given country, holding OIL constant, there is 3.97 times higher odds (relative to the baseline category of "no change") that the GDP difference will be negative when the country is a democracy.

\vspace{.25cm}

\noindent In a given country, holding OIL constant, there is 5.87 times higher odds (relative to the baseline category of "no change") that the GDP difference will be positive when the country is a democracy.

\vspace{.25cm}

\noindent In a given country, holding REG constant, there is 119.58 times higher odds (relative to the baseline category of "no change") that the GDP difference will be negative when the country's average ratio of fuel exports to total exports in 1984-1986 exceeded 50 percent.

\vspace{.25cm}

\noindent In a given country, holding REG constant, there is 97.17 times higher odds (relative to the baseline category of "no change") that the GDP difference will be positive when the country's average ratio of fuel exports to total exports in 1984-1986 exceeded 50 percent.
...
\noindent I ran an ordered multinomial logit, regressing GDPWdiff\_ordered against the variables REG and OIL (with no interaction). 
...
\noindent The cutoffs define the boundaries between how the model predicts category assignments. These thresholds are the graphical boundaries between categories. However, they are on a latent scale, so they lack interpretable units. 
...
\noindent For a one-unit increase in marginality.06 (representing the change from average poverty to high poverty), holding other variables constant, on average the log count of district visits decreases by approximately 2.08.
...
\noindent For a one-unit increase in PAN.governor.06 (representing the change from districts without a PAN governor to districts with a PAN governor), holding other variables constant, on average the log count of district visits decreases by approximately 0.31.
